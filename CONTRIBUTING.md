Contributing to OtsCoin Core
============================

The OtsCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the OtsCoin Core project, and is not to be
confused with overall OtsCoin Network Protocol consensus changes.

Whether a pull request is merged into OtsCoin Core rests with the project merge
...
Patches that change OtsCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the OtsCoin consensus, it must have been
...
The project leader is the release manager for each OtsCoin Core release.
