...
RESOURCES += src/qt/otscoin.qrc src/qt/otscoin_locale.qrc

TRANSLATIONS += src/qt/locale/otscoin_bg.ts \
                src/qt/locale/otscoin_de.ts \
                src/qt/locale/otscoin_en.ts \
                src/qt/locale/otscoin_es.ts \
                src/qt/locale/otscoin_fi.ts \
                src/qt/locale/otscoin_fr.ts \
                src/qt/locale/otscoin_it.ts \
                src/qt/locale/otscoin_ja.ts \
                src/qt/locale/otscoin_pl.ts \
                src/qt/locale/otscoin_pt.ts \
                src/qt/locale/otscoin_ru.ts \
                src/qt/locale/otscoin_sk.ts \
                src/qt/locale/otscoin_sv.ts \
                src/qt/locale/otscoin_vi.ts \
                src/qt/locale/otscoin_zh_CN.ts \
                src/qt/locale/otscoin_zh_TW.ts
