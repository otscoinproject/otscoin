...
This means one can have an always-on otscoind instance running, and another local otscoind/otscoin-qt instance which connects to this node and receives blocks from it.
