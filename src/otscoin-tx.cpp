...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("OtsCoin Core otscoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  otscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded otscoin transaction") + "\n" +
                               "  otscoin-tx [options] -create [commands]   " + _("Create hex-encoded otscoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded otscoin transaction
