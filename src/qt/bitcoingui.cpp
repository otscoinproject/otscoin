                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("OtsCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a OtsCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and otscoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zOTS"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About OtsCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about OtsCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for OtsCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your OtsCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified OtsCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a OtsCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the OtsCoin Core help message to get a list with possible OtsCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("OtsCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to OtsCoin network", "", count));
}
...
{
    QString strTitle = tr("OtsCoin Core"); // default title
