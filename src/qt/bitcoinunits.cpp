...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(OTS);
    unitlist.append(mOTS);
    unitlist.append(uOTS);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case OTS:
        return QString("otscoin");
    case mOTS:
        return QString("motscoin");
    case uOTS:
        return QString::fromUtf8("uotscoin");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case OTS:
            return QString("tOTS");
        case mOTS:
            return QString("mtOTS");
        case uOTS:
            return QString::fromUtf8("μtOTS");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case OTS:
            return QString("OTS");
        case mOTS:
            return QString("Milli-OTS (1 / 1" THIN_SP_UTF8 "000)");
        case uOTS:
            return QString("Micro-OTS (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case OTS:
            return QString("TestOTSs");
        case mOTS:
            return QString("Milli-TestOTS (1 / 1" THIN_SP_UTF8 "000)");
        case uOTS:
            return QString("Micro-TestOTS (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
