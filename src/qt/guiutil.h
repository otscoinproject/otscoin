...
/** Utility functions used by the OtsCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render OtsCoin addresses in monospace font
...
// Parse "otscoin:" URI into recipient object, return true on successful parsing
