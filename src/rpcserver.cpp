...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "OtsCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* OtsCoin features */
        {"otscoin", "masternode", &masternode, true, true, false},
        {"otscoin", "listmasternodes", &listmasternodes, true, true, false},
        {"otscoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"otscoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"otscoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"otscoin", "masternodedebug", &masternodedebug, true, true, false},
        {"otscoin", "startmasternode", &startmasternode, true, true, false},
        {"otscoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"otscoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"otscoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"otscoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"otscoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"otscoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"otscoin", "mnbudget", &mnbudget, true, true, false},
        {"otscoin", "preparebudget", &preparebudget, true, true, false},
        {"otscoin", "submitbudget", &submitbudget, true, true, false},
        {"otscoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"otscoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"otscoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"otscoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"otscoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"otscoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"otscoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"otscoin", "checkbudgets", &checkbudgets, true, true, false},
        {"otscoin", "mnsync", &mnsync, true, true, false},
        {"otscoin", "spork", &spork, true, true, false},
        {"otscoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"otscoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use otscoind, or the -server option to otscoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> otscoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:5741/\n";
}
